...
class Command(BaseCommand):
    ...
    def handle_goals_list(self, msg: Message, tg_user: TgUser):
        ...
        if result:
            ...
            self.tg_client.send_message(msg.chat.id, "[У тебя нет целей!]")
    ...
    def handle_goal_categories_list(self, msg: Message, tg_user: TgUser):
        ...
        if resp_categories:
            ...
            self.tg_client.send_message(msg.chat.id, "[У тебя нет категорий]")
    ...
    def handle_save_selected_category(self, msg: Message, tg_user: TgUser):
        if msg.text.isdigit():
            ...
            if GoalCategory.objects.filter(
                ...
                self.tg_client.send_message(msg.chat.id, "[Введите название]")
